...
ZFSS_LIST_OPTIONS="name,type,used,snapdir,com.sun:auto-snapshot,org.complete.simplesnap:exclude"
...
alias zlsn="zfs list -t snapshot -o $ZFSS_LIST_OPTIONS"
alias zlsng="zfs list -t snapshot -o $ZFSS_LIST_OPTIONS|grep"
...
# functions
nsn() {
	# scan up IP-Addr in the network
	# $1 = network CIDR
